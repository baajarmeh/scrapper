...
class BaseBaayObjectActions(object):
    """
    ...
    def get_urls(self):
        ...
        urls = super(BaseBaayObjectActions, self).get_urls()
    ...
    def change_view(self, request, object_id, form_url='', extra_context=None):
        ...
        return super(BaseBaayObjectActions, self).change_view(
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        return super(BaseBaayObjectActions, self).changelist_view(
    ...
    def get_change_actions(self, request, object_id, form_url):
        ...
        For example, to restrict actions to superusers, you could do:
            class ChoiceAdmin(BaayObjectActions, admin.ModelAdmin):
